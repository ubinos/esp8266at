...
void esp8266at_cli_at_interactive(esp8266at_t *esp8266at)
{
    ...
    st = esp8266at_cmd_at_interactive(esp8266at);
...
void esp8266at_cli_at_test(esp8266at_t *esp8266at)
{
    ...
    st = esp8266at_cmd_at_test(esp8266at, _timeoutms, NULL);
    printf("result : status = %d\n", st);
}
...
void esp8266at_cli_at_query_version(esp8266at_t *esp8266at)
{
    ...
    st = esp8266at_cmd_at_gmr(esp8266at, _timeoutms, NULL);
    printf("result : status = %d, version = %s\n", st, esp8266at->version);
}
...
void esp8266at_cli_at_query_dns(esp8266at_t *esp8266at)
{
    ...
    st = esp8266at_cmd_at_cipdns_q(esp8266at, _timeoutms, NULL);
    printf("result : status = %d, enable = %d", st, esp8266at->dns_enable);
...
void esp8266at_cli_at_query_sntpcfg(esp8266at_t *esp8266at)
{
    ...
    st = esp8266at_cmd_at_cipsntpcfg_q(esp8266at, _timeoutms, NULL);
    printf("result : status = %d, enable = %d, timezone=%d", st, esp8266at->sntp_enable, esp8266at->sntp_timezone);
...
void esp8266at_cli_at_query_sntptime(esp8266at_t *esp8266at)
{
    ...
    st = esp8266at_cmd_at_cipsntptime(esp8266at, &tm_data, _timeoutms, NULL);
    printf("result : status = %d, year = %d, mon = %d, mday = %d, wday = %d, hour = %d, min = %d, sec = %d\n", st,
...
int esp8266at_cli_at_config_echo(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_e(esp8266at, is_on, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_config_wmode(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    st = esp8266at_cmd_at_cwmode(esp8266at, mode, _timeoutms, NULL);
    printf("result : status = %d\n", st);
    r = 0;
...
int esp8266at_cli_at_config_ipmux(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    st = esp8266at_cmd_at_cipmux(esp8266at, mode, _timeoutms, NULL);
    printf("result : status = %d\n", st);
    r = 0;
...
int esp8266at_cli_at_ap_join(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        st = esp8266at_cmd_at_cwjap(esp8266at, esp8266at->ssid, esp8266at->passwd, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_ap_quit(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        st = esp8266at_cmd_at_cwqap(esp8266at, _timeoutms, NULL);
        if (st != UBI_ST_OK) {
            break;
        }
...
int esp8266at_cli_at_ap_query_ip(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    st = esp8266at_cmd_at_cifsr(esp8266at, _timeoutms, NULL);
    if (st != UBI_ST_OK)
    {
        r = -1;
    }
    printf("result : status = %d, ip_addr = %s, mac_addr = %s\n", st, esp8266at->ip_addr, esp8266at->mac_addr);
...
int esp8266at_cli_at_conn_open(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_cipstart(esp8266at, type, ip, port, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_conn_close(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        st = esp8266at_cmd_at_cipclose(esp8266at, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_conn_send(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        st = esp8266at_cmd_at_cipsend(esp8266at, (uint8_t*) str, (uint32_t) len, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_conn_recv(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_ciprecv(esp8266at, _recv_buf, read_len, &read, _timeoutms, NULL);
        _recv_buf[read] = 0;
...
int esp8266at_cli_at_mqtt_topic(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_mqtttopic(esp8266at, pub_topic, sub_topic, sub_topic_2, sub_topic_3, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_open(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_mqttconn(esp8266at, ip, port, reconnect, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_close(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        st = esp8266at_cmd_at_mqttclean(esp8266at, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_pub(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_mqttpub(esp8266at, topic, (char *) _mqtt_msg_buf, qos, retain, _timeoutms, NULL);
#else
        sscanf(str, "%s %s %lu %lu", topic, _mqtt_msg_buf, &qos, &retain);
        st = esp8266at_cmd_at_mqttpubraw(esp8266at, topic, (char *) _mqtt_msg_buf, strlen((char *)_mqtt_msg_buf), qos, retain, _timeoutms, NULL);
#endif /* (ESP8266AT__USE_WIZFI360_API == 1) */
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_sub(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_mqttsub(esp8266at, id, topic, qos, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_unsub(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    {
        sscanf(str, "%lu", &id);
        st = esp8266at_cmd_at_mqttunsub(esp8266at, id, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_sublist(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_mqttsub_q(esp8266at, _timeoutms, NULL);
        printf("result : status = %d\n", st);
        r = 0;
...
int esp8266at_cli_at_mqtt_subget(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        st = esp8266at_cmd_at_mqttsubget(esp8266at, id, _recv_buf, max_len, &read, _timeoutms, NULL);
        _recv_buf[read] = 0;
...
int esp8266at_cli_echo_client(esp8266at_t *esp8266at, char *str, int len, void *arg)
{
    ...
    do
    {
        ...
        printf("\n==== Config echo on ====\n\n");
        st = esp8266at_cmd_at_e(esp8266at, 1, _timeoutms, NULL);
        if (st != UBI_ST_OK)
        {
            r = -1;
            break;
        ...
        st = esp8266at_cmd_at_cipmux(esp8266at, 0, _timeoutms, NULL);
        if (st != UBI_ST_OK)
        {
            r = -1;
            break;
        ...
        printf("\n==== Config WiFi mode 1 ====\n\n");
        st = esp8266at_cmd_at_cwmode(esp8266at, 1, _timeoutms, NULL);
        if (st != UBI_ST_OK)
        {
            r = -1;
            break;
        ...
        printf("\n==== Join to an AP ====\n\n");
        st = esp8266at_cmd_at_cwjap(esp8266at, ssid, passwd, _timeoutms * 3, NULL);
        if (st != UBI_ST_OK)
        {
            r = -1;
            break;
        ...
        printf("\n==== Open connection ====\n\n");
        st = esp8266at_cmd_at_cipstart(esp8266at, "TCP", ip, port, _timeoutms * 3, NULL);
        if (st != UBI_ST_OK)
        {
            r = -1;
            break;
        ...
        for (uint32_t i = 0; i < count; i++)
        {
            ...
            msglen = strlen(msg);
            st = esp8266at_cmd_at_cipsend(esp8266at, (uint8_t*) msg, msglen, _timeoutms, NULL);
            if (st != UBI_ST_OK)
            {
                break;
            }
            ...
            printf("\n---- Receive message ----\n");
            st = esp8266at_cmd_at_ciprecv(esp8266at, _recv_buf, msglen, &read, _timeoutms, NULL);
            if (st != UBI_ST_OK)
            {
                break;
            }
